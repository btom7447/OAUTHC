...
export const ServiceProvider = ({ children }) => {
    ...
    ].filter(service => service.name).sort((a, b) => a.name.localeCompare(b.name));
    ...
    const diseasesData = [
      ...
      ].filter(disease => disease.name).sort((a, b) => a.name.localeCompare(b.name));
    ...
    ].filter(test => test.name).sort((a, b) => a.name.localeCompare(b.name));    
